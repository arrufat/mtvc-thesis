...
\tikzstyle{every node}=[font=\scriptsize]
	...
	\bloq{\startx,\starty-1.25}{ipk}{text width=4.5em,fill=yellow!50}{IPM $k$}
	...
	\bloq{\startx+2.3*\hdist,\starty-1.75}{rec}{text width=5em}{reconstruction}
	...
	\propnode{\startx+3.25,-1.75}{add1}{fill=green!50}{0}{\small+}
