...
There are some remarkable points, such as the system at \unit{8}{\kilo B},
which can achiver bit-rate savings of over 2\% with a complexity slightly
higher than twice of \ac{HEVC}'s.
Another interesting point is the \unit{64}{\kilo B} system, being able to
...
\begin{figure}[tb]
	...
	\caption{Average $4\times4$ residual profiles showing the symmetries
	around \acs{IPM} 18}
...
\begin{figure}[tb]
	...
	\foreach \direction in {2}
	{
		...
		$\qquad\curvearrowupdown\directionm$
	...
	\foreach \direction in {3,4,5,6,7,8,9}
	{
		...
		%
		\pgfmathtruncatemacro{\directiontm}{52-\directiont}
		$\qquad\curvearrowupdown\directiontm^T$ % rotation 90 = transposition + mirror
...
\end{minipage}
	...
	\label{fig:symmetry_transposed_mirror}
\end{figure}
...
\begin{table}[tb]
	...
	\begin{tabular}{c|rr|rr|rr|r}
		...
		32 & \unit{52.50}{\kilo B} & -1.0\% & \unit{28.50}{\kilo B} & -0.9\% & \unit{16.50}{\kilo B} & -0.8\% & 530\% \\
	\end{tabular}
