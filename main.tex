...
\begin{figure}[tp]
	\centering
	\includegraphics{./figures/dist_zero_plot.pdf}
	\caption{Distortion and $\ell_0$ norm with $\lambda_{opt}$ at \acs{QP} 27
...
\begin{figure}[tp]
	...
	\caption{$J(\lambda)$ for different \ac{GGD} modelling the rate with
