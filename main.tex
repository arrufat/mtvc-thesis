...
introduced almost no increase in the decoding time with regards to the
\ac{DCT}.
...
\begin{align}
	...
	\sqrt{\frac{2}{N}}\cos\left(\frac{\pi(n+1)(k+1)}{4N}\right)
	\\ % DCT-V
	{\left[C_{N}^{V} \right]}_{n,k} & =
	\frac{2}{\sqrt{2(N-1)+1}}\epsilon_n\epsilon_k\cos\left(\frac{\pi(2n+1)k}{2N}\right)
	\quad
	\epsilon_n,\epsilon_k =
	\begin{cases}
		\frac{1}{\sqrt{2}} & n, k = 0 \\
	...
	\frac{2}{\sqrt{2(N-1)}}\cos\left(\frac{\pi(n+1)n}{4N-2}\right)
	\\ % DST-I
	...
	\frac{2}{\sqrt{2(N-1)+1}}\epsilon_n\epsilon_k\sin\left(\frac{\pi(2n+1)(k+1)}{2((2N-1)+1)}\right)
	\quad
	\epsilon_n,\epsilon_k =
	\begin{cases}
		\frac{1}{\sqrt{2}} & n, k = M-1 \\
		1 & \text{otherwise}
	\end{cases}
\end{align}
