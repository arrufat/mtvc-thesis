...
\def\useINSAcover{1} % whether to use the INSA front and back covers
...
\ac{HEVC}, as the work carried out in this thesis will focus on the intra
...
This section will present the two distortion measures for objective quality
used in this thesis.
...
standardisation, even if they have proven to be inconsistent with the
\ac{HVS}.
...
video coding.
Although this Chapter is mainly a summary of the literature, a technical
novelty is brought in \S\ref{sub:the_lagrange_multiplier}.
...
\end{itemize}
The number of transforms per block size have been chosen to guarantee that
