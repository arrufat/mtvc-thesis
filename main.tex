...
together~\cite{sole-12-transform-coefficient-coding,
ye-08-intra-directional-scanning-mddt}.
...
\acp{IPM} present notable differences and an adapted transform for each
\ac{IPM} can provide good signal compaction by specialisation.
An example of this differences has been presented in figure~\ref{fig:mdcs} for
$4\times4$ prediction residuals.
...
In \S~\ref{sub:particular_case_dst} the \ac{DST} has been presented as the
\ac{KLT} for intra prediction residuals.
