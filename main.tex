...
\begin{table}[tb]
	...
	\begin{tabular}{c|rr|rr}
		...
		\multicolumn{1}{c}{Y \acs{BD}-rate} \\
		\hline \hline
		1  &  \unit{1.64}{\kilo B} & -0.5\% &  \unit{0.52}{\kilo B} & -0.4\% \\
		2  &  \unit{3.28}{\kilo B} & -0.7\% &  \unit{1.03}{\kilo B} & -0.5\% \\
		4  &  \unit{6.56}{\kilo B} & -0.8\% &  \unit{2.06}{\kilo B} & -0.6\% \\
		8  & \unit{13.13}{\kilo B} & -0.9\% &  \unit{4.13}{\kilo B} & -0.7\% \\
		16 & \unit{26.25}{\kilo B} & -1.0\% &  \unit{8.25}{\kilo B} & -0.8\% \\
		32 & \unit{52.50}{\kilo B} & -1.0\% & \unit{16.50}{\kilo B} & -0.8\% \\
	\end{tabular}
