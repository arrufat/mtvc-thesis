...
The naïve approach to work with those signals is to use non-separable
transforms.
...
The algorithmic complexity for a mono-dimensional \ac{DTT} is in the order of
$N\log_2(N)$ instead of the naïve $N^2$, where $N$ stands for the transform
...
\begin{table}[tb]
	...
	\begin{tabular}{c|cc|cc}
		...
		\hline
		$4\times4$ &  16 &  48 B &  8 & 16 B \\
		$8\times8$ & 128 & 192 B & 24 & 64 B \\
	\end{tabular}
...
The most used transforms are the \acs{DCT}\_IV-\acs{DCT}\_IV,
\acs{DCT}\_III-\acs{DCT}\_IV, the \acs{DST}\_VII-\acs{DCT}\_IV and the
\acs{DCT}\_V-\acs{DCT}\_IV.
% TODO
