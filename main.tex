...
\label{sub:performances_of_different_configurations}
...
Chapter~\ref{cha:the_mode_dependent_directional_transforms}, \ac{MDTC} explore
many more coding alternatives, which leads to signficant increments in terms
of encoding time: up to 8--10 times the complexity of the reference \ac{HEVC}
encodings for the high performance \acs{MDTC} system, depending on
separability.
...
Chapters~\ref{cha:the_mode_dependent_directional_transforms}
and~\ref{cha:the_mode_dependent_transform_competition} have presented the
great potential of non-separable transforms in terms of bit-rate savings for
video coding.
