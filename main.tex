...
Appendix~\ref{cha:transform_usage_in_mdtc_systems} contains the transform
configuration for the systems shown in table~\ref{tab:non_hom_sym_mdtc} for
both $4\times4$ and $8\times8$ \acp{TU} in table~\ref{tab:config_sym_dtt}.
