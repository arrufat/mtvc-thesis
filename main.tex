...
In this section, the \ac{KLT} will be studied for a particular kind of
...
\end{equation}
The \ac{KLT} for this kind of processes tends to the DCT as
$\rho\to1$~\cite{britanak-06-dct-and-dst}.
...
Although the \ac{DCT} has been proved to be nearly optimal for natural
