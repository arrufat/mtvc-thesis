...
Provided that \ac{MDTC} systems learnt using this metric lead to significant
bit-rate savings with respect to \ac{HEVC}, it will be used in this Chapter to
design an \ac{DTT}-based \ac{MDTC} system.
The learning method is based on algorithm~\ref{alg:clustering}.
