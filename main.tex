...
more and more common, new needs for video compression appear that must exploit
...
In 2003, the H.264/\acs{MPEG}-4 \acs{AVC} standard norm was defined, providing
a compression rate of around 50\% with regards the previous standard, defined
in 1993.
...
\acs{HEVC} norm almost completely defined.
Consequently, the focus has been put on improving the \acs{HEVC} standard with
new techniques that might be adopted in a future standard.

Since new video coding standard appear relatively spaced in time, due to
marketing constraints, and being in the beginning of the post-\acs{HEVC} era,
first steps in this thesis will strive achieve important bit-rate savings over
\acs{HEVC} by relaxing complexity constraints.
However, since the work is carried out in an industrial research laboratory
(Orange Labs), following steps are focused on yielding the coding system
inside reasonable complexity boundaries.
