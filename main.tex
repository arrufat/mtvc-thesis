...
% TODO
\todo{Understand what happens}
For some reason, performances of the symmetrical system are higher than those
of the non-symmetrical system.
...
\begin{table}[tb]
	\centering
% TODO
\todo{recompute ROM values for 48--128 to have 2 decimal places}
	\small
	\begin{tabular}{r|r|r|r}
	System & \multicolumn{1}{c|}{\acs{ROM}} & Y \acs{BD}-rate & Complexity \\
	\hline\hline
	 ...
	 \SI{64}{\kilo B} &  \SI{63.80}{\kilo B} & -3.28\% &  776\% \\
	 \SI{96}{\kilo B} &  \SI{88.90}{\kilo B} & -3.45\% & 1084\% \\
	\SI{128}{\kilo B} & \SI{123.40}{\kilo B} & -3.56\% & 1322\% \\
	\end{tabular}
...
heterogeneous \ac{MDTC} systems for the same bit-rate savings.
...
\chapter{Systems summary}
\label{cha:systems_summary}
\chaptertoc

\section{Motivation}
\label{sec:summary_motivation}

This final Chapter has been created with one goal in mind:
to ease the choice amongst all explored systems in this thesis responding to
different trade-offs.

In Chapters~\ref{cha:real_world_system} and~\ref{cha:dtt} several systems have
...
\begin{table}[tb]
	...
	Finally, the encoding complexity of each system is also provided.}
