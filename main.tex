...
\subsection{Transform learning}
\label{sub:mddt_transform_learning}
...
\begin{figure}[tb]
	...
	\caption{\ac{RDOT} metric evolution during different transform learnings}
...
\begin{figure}[tp]
	...
	\caption{Clustering and transform learning}
