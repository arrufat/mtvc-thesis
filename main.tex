...
\hypersetup{
	...
	pdfkeywords={video, image, transform, coding, compression},
	pdfinfo={
...
The members of the jury deserve a distinctive mention as well for having
accepted to review, assisted to my PhD defence and given constructive
feedback.
...
outperforms H.264/\acs{MPEG}-4 by 50\% in terms of bitrate savings for
...
This image evidences the parts of the picture that could not be predicted and
...
Pictures coded using this technique exclusively are named I-frames.
...
consecutive pictures share many similarities, and that some of their component
...
from the future are called predicted pictures or P-frames.
Bi-predicted pictures or B-frames have prediction origins in two different
pictures.
...
are organised into \acp{GOP}, formed by an I-frame, and several P and
B-frames.
...
\ref{sec:klt}) and the \acs{RDOT} (\S
\ref{sec:rdot}).
...
performance of \ac{AVC} were explored and designated as
...
After having confirming that the learning has output better performing
...
some synthetic objects, whereas the rest of sequences are exclusively composed
of natural images issued from different sources, frame rates and resolutions.
...
\begin{itemize}
	...
	% \item Vertical mirroring: $\overset{\curvearrowleftright}{\x}$
...
\begin{itemize}
	...
	\item \acs{HEVC} provided 23\% of bitrate savings with regards \acs{AVC}
