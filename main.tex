...
This facts motivated a study on this particular blocks, resuling in a
transform that performs better on them than the \ac{DCT}: the \ac{DST}.
\begin{figure}[tb]
	\centering
	\subfloat[Prediction modes for the current block (white) from previously
	reconstructed blocks (grey)]
	{\input{./figures/pred-scheme.pgf}}
	\hspace{0.2\linewidth}
