...
bit allocation by distributing the transformed coefficient variances in such a
way as to minimise their geometric
mean~\cite{jayant-84-digital-coding-waveforms} and minimises the overall
...
\subsubsection{Final note on the \ac{KLT}}
\label{ssub:final_note_on_the_klt}
