...
% TODO
\todo{Re-encode $8\times8$ system to increase precision}
\begin{table}[tb]
	\centering
	\begin{tabular}{r|r|r|r}
	System & \multicolumn{1}{c|}{\acs{ROM}} & Y \acs{BD}-rate & Complexity \\
	\hline\hline
	  4s0--8s1 &   \SI{6.56}{\kilo B} & -0.84\% &  130\% \\
	  4s0--8s2 &  \SI{13.13}{\kilo B} & -1.33\% &  140\% \\
	  4s0--8s4 &  \SI{26.25}{\kilo B} & -1.72\% &  170\% \\
	  4s0--8s8 &  \SI{52.50}{\kilo B} & -2.10\% &  230\% \\
	 4s0--8s16 & \SI{105.00}{\kilo B} & -2.48\% &  340\% \\
	 4s0--8s32 & \SI{210.00}{\kilo B} & -2.79\% &  580\% \\
	 4s0--8s64 & \SI{420.00}{\kilo B} & -3.07\% & 1000\% \\
	4s0--8s128 & \SI{840.00}{\kilo B} & -3.33\% & 2000\% \\
	\end{tabular}
...
\begin{table}[tb]
	...
	\begin{tabular}{c|rr|rr|rr|r}
		...
		\hline \hline
		 1 &  \SI{1.64}{\kilo B} & -0.49\% &  \SI{0.52}{\kilo B} & -0.50\% & 127\% \\
		 2 &  \SI{3.28}{\kilo B} & -0.67\% &  \SI{1.03}{\kilo B} & -0.63\% & 141\% \\
		 4 &  \SI{6.56}{\kilo B} & -0.82\% &  \SI{2.06}{\kilo B} & -0.72\% & 167\% \\
		 8 & \SI{13.13}{\kilo B} & -0.93\% &  \SI{4.13}{\kilo B} & -0.84\% & 219\% \\
		16 & \SI{26.25}{\kilo B} & -0.98\% &  \SI{8.25}{\kilo B} & -0.91\% & 322\% \\
		32 & \SI{52.50}{\kilo B} & -1.01\% & \SI{16.50}{\kilo B} & -0.93\% & 527\% \\
	\end{tabular}
...
\begin{table}[tb]
	...
	\begin{tabular}{c|rr|rr|rr|r}
		...
		\multicolumn{1}{c}{Complexity} \\
		\hline \hline
		  1 &   \SI{6.56}{\kilo B} & -0.84\% &   \SI{2.06}{\kilo B} & \% & \% \\
		  2 &  \SI{13.13}{\kilo B} & -1.33\% &   \SI{4.13}{\kilo B} & \% & \% \\
		  4 &  \SI{26.25}{\kilo B} & -1.72\% &   \SI{8.25}{\kilo B} & \% & \% \\
		  8 &  \SI{52.50}{\kilo B} & -2.10\% &  \SI{16.50}{\kilo B} & \% & \% \\
