\begin{tikzpicture}[scale=1.25]
	...
	\draw (-0.57, 0.5) node[below] {\small 1: \color{\colour}{DC}};
	...
	% label IPM groups
	\draw (4.5,1.3) node {\small basic modes};
	\draw (4.5,-1.7) node {\small mirrored modes};
	\draw (2.5,-4.0) node {\small transposed and mirrored modes};
	\draw (-1.5,-4.0) node {\small transposed modes};
